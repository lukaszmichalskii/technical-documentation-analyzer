...
from src.plugins.default_plugin import (
    PDFDecoder,
    DocxDecoder,
    TextProvider,
    remove_escape_chars,
...
class TestTextParse(unittest.TestCase):
    ...
    def test_decoder_read_pdf(self) -> None:
 ...
 text. And more text. And more text. Even more. Continued on page 2 ..."""
    ...
    def test_read_docx_files(self) -> None:
        ...
        expected = (
            "Vestibulum neque massa, scelerisque sit amet ligula eu, congue molestie mi. Praesent ut varius "
    ...
    def test_text_provider_read_pdf(self) -> None:
        pdf_ = self.resources.joinpath("dir/sample.pdf")
        expected = (
    ...
    def test_text_provider_read_docx(self) -> None:
