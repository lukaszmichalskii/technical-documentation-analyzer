...
def print_file_content(filename, text: str | typing.Generator[str, None, None], chunk: bool = False):
...
class FileManager:
    ...
    @staticmethod
    def files_in_dir(directory: pathlib.Path) -> typing.List[str | bytes | typing.Any] | None:
        files = []
