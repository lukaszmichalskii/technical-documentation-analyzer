from src.nlp.ner import (
    ...
    subj_equals_obj,
    create_word_vectors,
    check_for_string_labels,
)
from src.nlp.svo import create_svo_triples

if __name__ == "__main__":
    documentation = """Camera recognition is a component of control pipeline of SEE part of autonomous system. It is 
...
Camera recognition is a ROS2 node running on autonomous system main unit"""
    ...
    # svo triples
    initial_tup_ls = create_svo_triples(documentation, debug=True)
